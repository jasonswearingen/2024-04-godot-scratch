...
/// <summary>
/// mark a node class with this interface to have it be scanned for properties that need to be injected from DI.
/// <para>this interface is used to improve performance, so most nodes are not scanned for DI</para>
/// </summary>
