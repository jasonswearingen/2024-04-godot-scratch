...
public static class zz_Extensions_Exception
{
   ...
   public static bool _Find<TException>(this Exception? exception, [NotNullWhen(true)] out TException? found) where TException : Exception
   {
      ...
      if (exception.InnerException._Find<TException>(out found))
      {
         return true;
      }
      ...
      if (exception is AggregateException ae)
      {
         ...
         {
            if (inner._Find<TException>(out found))
            {
               return true;
            }
         }
...
#pragma warning restore ERP022, RCS1075 // Avoid empty catch clause that catches System.Exception.
   ...
   /// </remarks>
   public static void _SyncWait(this ValueTask task, bool continueOnCapturedContext = false)
   {
      if (continueOnCapturedContext)
      {
         task.AsTask().ConfigureAwait(true).GetAwaiter().GetResult();
      }
      else
      {
   ...
   public static void _SyncWait(this Task task, bool continueOnCapturedContext = false)
   {
      if (continueOnCapturedContext)
      {
   ...
   public static TResult _SyncWait<TResult>(this ValueTask<TResult> task, bool continueOnCapturedContext = false)
   {
      if (continueOnCapturedContext)
      {
   ...
   public static TResult _SyncWait<TResult>(this Task<TResult> task, bool continueOnCapturedContext = false)
   {
      if (continueOnCapturedContext)
      {
         return task.ConfigureAwait(true).GetAwaiter().GetResult();
...
public static class zz_Extensions_Numeric
{
   ...
   public static bool _AproxEqual(this double value, double other)
   {
      ...
      return _AproxEqual(value, other, tolerance);
   }
...
public static class zz_Extensions_IEnumerable
{
   ...
   /// <param name="source"></param>
   /// <returns></returns>
   public static List<TValue> _Clone<TValue>(this IEnumerable<TValue> source)
   {
      //try to clone all values
...
public static class zz_Extensions_Random
{
   ...
   {
      return _NextTimeSpan(rand, 0, maxSeconds);
   }
...
public static class zz_Extensions_String
{
   ...
   public static string _FormatAppendArgs(this string message,
      object? arg0 = null, object? arg1 = null, object? arg2 = null,
   ...
   /// <summary>
   ///    ignores case, trims, and culture
   /// </summary>
   /// <param name="value"></param>
   /// <param name="other"></param>
   /// <returns></returns>
   public static bool _AproxEqual(this string value, string other)
   {
      ...
      return value.Trim().Equals(other.Trim(), StringComparison.InvariantCultureIgnoreCase);
   }
   ...
   public static string _GetBefore(this string value, string right, bool fullIfRightMissing)
   {
      ...
      return xPos == -1 ? fullIfRightMissing ? value : string.Empty : value.Substring(0, xPos);
   }
   ...
   /// <returns></returns>
   public static string _GetAfter(this string value, string left, bool fullIfLeftMissing,
